...
export default function NavLinksRfps() {
  ...
  return (
    <>
      <h1 className="capitalize text-lg pb-2 font-bold"> Your RFPs</h1>  
      {rfps.map((link) => {
        ...
        return (
          ...
          >
            <svg className="h-6 w-6 flex-none fill-blue-300 stroke-black stroke-2" stroke-linecap="round" stroke-linejoin="round">
